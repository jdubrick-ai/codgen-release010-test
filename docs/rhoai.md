...
3) Access the `workbench` named `codgen-release010-test-notebook`.
...
5) In the terminal, run `cd codgen-release010-test` to navigate to your sample app's directory.
